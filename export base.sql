...
CREATE TABLE `cliente_has_producto` (
  ...
  CONSTRAINT `cliente_has_producto_ibfk_1` FOREIGN KEY (`cliente_dni`) REFERENCES `cliente` (`codigo`),
  CONSTRAINT `cliente_has_producto_ibfk_2` FOREIGN KEY (`producto_codigo`) REFERENCES `producto` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-26 16:16:11
